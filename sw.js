const CACHE='setbook-v3-4-2';
const ASSETS=['./','./index.html','./styles.css','./manifest.json','./app.js','./program-preview.js','./cloud.js','./cloud-ui.js','./model.js','./storage.js','./library.js','./analysis.js','./views.js','./icon-192.png','./icon-512.png'];
