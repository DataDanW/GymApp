const CACHE='setbook-v3-4-3';
const ASSETS=['./','./index.html','./styles.css','./manifest.json','./app.js','./today-view.js','./program-preview.js','./cloud.js','./cloud-ui.js','./model.js','./storage.js','./library.js','./analysis.js','./views.js','./icon-192.png','./icon-512.png'];
